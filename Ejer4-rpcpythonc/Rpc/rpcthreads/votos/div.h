...
#define DIV_PROG 0x23451111
#define DIV_VERS 1

#if defined(__STDC__) || defined(__cplusplus)
#define div 1
extern  enum clnt_stat div_1(numbers *, int *, CLIENT *);
extern  bool_t div_1_svc(numbers *, int *, struct svc_req *);
extern int div_prog_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define div 1
extern  enum clnt_stat div_1();
extern  bool_t div_1_svc();
